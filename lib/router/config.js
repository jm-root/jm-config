...
module.exports = function (service, opts) {
  ...
  /**
     ...
     *     }
     */
  routes.listConfig = async function(opts) {
    opts.data.root = opts.params.root || null
  ...
  /**
     ...
     *     }
     */
  routes.setConfigs = async function (opts) {
    opts.data.root = opts.params.root || null
    let data = opts.data
    if (data.json) {
      try {
        data.json = JSON.parse(data.value)
      } catch (e) {
        return ERR.FA_PARSE_CONFIG
      }
    }
    let doc = await config.setConfigs(data)
  ...
  var _listConfig = function (opts) { return routes.listConfig(opts) }
  var _setConfigs = function (opts) { routes.setConfigs(opts) }
